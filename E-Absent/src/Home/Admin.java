...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Home/E-ABSENT SMAN 9 GARUT (1).png"))); // NOI18N
        ...
        jButton1.setBackground(new java.awt.Color(252, 217, 0));
    ...
    private void tmbhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tmbhActionPerformed
        try {
            String sql = "INSERT INTO siswa (nis, nama, kls, prodi, jns_klmn, no_telp, mapel_plhn1, mapel_plhn2, mapel_plhn3) VALUES ('"
                    + nim.getText() + "','"
                    + nama.getText() + "','"
                    + kls.getText() + "','"
                    + prodi.getText() + "','"
